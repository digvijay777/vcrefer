...
const IID *  _XWebPlugins2_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _XWebPlugins2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _XWebPlugins2, pIID, n)

int __stdcall _XWebPlugins2_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_XWebPlugins2_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo XWebPlugins2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _XWebPlugins2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _XWebPlugins2_StubVtblList,
    (const PCInterfaceName * ) & _XWebPlugins2_InterfaceNamesList,
    (const IID ** ) & _XWebPlugins2_BaseIIDList,
    & _XWebPlugins2_IID_Lookup, 
    1,
    2,
