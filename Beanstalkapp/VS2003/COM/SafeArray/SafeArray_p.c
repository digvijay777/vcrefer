...
extern const MIDL_SERVER_INFO IArrayTest_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IArrayTest_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISTAtest_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISTAtest_ProxyInfo;
...
/* Object interface: IArrayTest, ver. 0.0,
   GUID={0xE131B8EE,0xA6BE,0x4045,{0xB5,0xCB,0x8A,0x86,0xE9,0xE0,0xD2,0x3E}} */

#pragma code_seg(".orpc")
static const unsigned short IArrayTest_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IArrayTest_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IArrayTest_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IArrayTest_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(9) _IArrayTestProxyVtbl = 
{
    &IArrayTest_ProxyInfo,
    &IID_IArrayTest,
    ...
    (void *) (INT_PTR) -1 /* IArrayTest::TestBSTRArray */ ,
    (void *) (INT_PTR) -1 /* IArrayTest::GetObject */
};


static const PRPC_STUB_FUNCTION IArrayTest_table[] =
{
...
CInterfaceStubVtbl _IArrayTestStubVtbl =
{
    &IID_IArrayTest,
    &IArrayTest_ServerInfo,
    9,
    &IArrayTest_table[-3],
...
/* Object interface: ISTAtest, ver. 0.0,
   GUID={0x4C4C3A14,0x975A,0x44D1,{0xA9,0x90,0x81,0xC4,0xD0,0x2B,0xDE,0x9C}} */

#pragma code_seg(".orpc")
static const unsigned short ISTAtest_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ISTAtest_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &ISTAtest_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISTAtest_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _ISTAtestProxyVtbl = 
{
    &ISTAtest_ProxyInfo,
    &IID_ISTAtest,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ISTAtest::GetID */
};


static const PRPC_STUB_FUNCTION ISTAtest_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ISTAtestStubVtbl =
{
    &IID_ISTAtest,
    &ISTAtest_ServerInfo,
    8,
...
const CInterfaceProxyVtbl * _SafeArray_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISTAtestProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IArrayTestProxyVtbl,
    0
};

const CInterfaceStubVtbl * _SafeArray_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISTAtestStubVtbl,
    ( CInterfaceStubVtbl *) &_IArrayTestStubVtbl,
    0
...
PCInterfaceName const _SafeArray_InterfaceNamesList[] = 
{
    "ISTAtest",
    "IArrayTest",
    0
...
const IID *  _SafeArray_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _SafeArray_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SafeArray, pIID, n)

int __stdcall _SafeArray_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SafeArray, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SafeArray, 2, *pIndex )
    
}

const ExtendedProxyFileInfo SafeArray_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SafeArray_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SafeArray_StubVtblList,
    (const PCInterfaceName * ) & _SafeArray_InterfaceNamesList,
    (const IID ** ) & _SafeArray_BaseIIDList,
    & _SafeArray_IID_Lookup, 
    2,
    2,
