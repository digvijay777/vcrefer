...
class ATL_NO_VTABLE CMyTree : 
	...
	public IDispatchImpl<IMyTree, &IID_IMyTree, &LIBID_MFCCtrlTestLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	...
	public IProvideClassInfo2Impl<&CLSID_MyTree, NULL, &LIBID_MFCCtrlTestLib>,
	public CComCoClass<CMyTree, &CLSID_MyTree>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_MYTREE)

BEGIN_COM_MAP(CMyTree)
	COM_INTERFACE_ENTRY(IMyTree)
...
public:
		...
		LPCTSTR pszText = _T("ATL 7.0 : MyTree");
		TextOut(di.hdcDraw, 
			(rc.left + rc.right) / 2, 
			(rc.top + rc.bottom) / 2, 
			pszText, 
...
OBJECT_ENTRY_AUTO(__uuidof(MyTree), CMyTree)
