...
BEGIN_MESSAGE_MAP(CBatchEmailApp, CWinApp)
...
// 唯一的一个 CBatchEmailApp 对象

CBatchEmailApp theApp;

// CBatchEmailApp 初始化

BOOL CBatchEmailApp::InitInstance()
{
...
// 用于运行对话框的应用程序命令
void CBatchEmailApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
