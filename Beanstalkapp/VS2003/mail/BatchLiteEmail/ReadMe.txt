================================================================================
    MICROSOFT 基础类库： BatchLiteEmail 项目概述
===============================================================================

应用程序向导已为您创建了此 BatchLiteEmail 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 BatchLiteEmail 应用程序的每个文件的内容摘要。

BatchLiteEmail.vcproj
...
BatchLiteEmail.h
    ...
    CBatchLiteEmailApp 应用程序类。

BatchLiteEmail.cpp
    这是包含应用程序
    类 CBatchLiteEmailApp 的主应用程序源文件。
...
res\BatchLiteEmail.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 BatchLiteEmail.rc 中。

res\BatchLiteEmail.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 BatchLiteEmail.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

BatchLiteEmailDoc.h、BatchLiteEmailDoc.cpp - 文档
    这些文件包含 CBatchLiteEmailDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CBatchLiteEmailDoc::Serialize）。
BatchLiteEmailView.h、BatchLiteEmailView.cpp - 文档视图
    这些文件包含 CBatchLiteEmailView 类。
    CBatchLiteEmailView 对象用于查看 CBatchLiteEmailDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 BatchLiteEmail.pch 的预编译头文件 (PCH)
