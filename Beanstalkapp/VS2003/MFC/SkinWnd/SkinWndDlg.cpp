...
CSkinWndDlg::CSkinWndDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CSkinWndDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CSkinWndDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
void CSkinWndDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CSkinWndDlg::OnBnClickedOk()
{
