...
#include "../../../ExtClass/wmi/WMIAdapter.h"
...
void CAdapterDlg::OnBnClickedButton1()
{
	CWMIAdapter		adapter;

	adapter.InitAdapterInfo();
//	adapter.GetAdapterCount();
// 	adapter.SetGateWay(8, L"192.168.1.1");
// 	adapter.SetIP(8, L"192.168.1.204;192.168.2.204", L"255.255.255.0;255.255.255.0");
	adapter.SetDNS(8, L"192.168.1.11");
// 	netadapter();
}
